# Тест: 1.6. Проверка успешной авторизации с валидными данными
...
def test_sort_by_name_a_to_z():
    ...
    assert names_list == sorted(names_list), "Ошибка сортировки"
    print("Товары отсортированы по названию от A к Z")
